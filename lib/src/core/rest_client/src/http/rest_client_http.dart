...
import 'package:rick_and_morty/src/core/rest_client/src/http/check_exception_io.dart'
    if (dart.library.js_interop) 'package:rick_and_morty/src/core/rest_client/src/http/check_exception_browser.dart';
